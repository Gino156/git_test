...
<body>
    <div class="container">
        <h1>Request New Document(Brgy Residency)</h1>
        <div class="status">
            <?php
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                ...
                $stmt = $conn->prepare("INSERT INTO residency_request (lastName, firstName, middleName, address, street, birthday, age, phone, citizenship) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)");
